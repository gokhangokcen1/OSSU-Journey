...
; 
; This is great, you can make it do anything. There's just one problem, this verios of
...
; for Natural, as well as the idea that add1 is kind of like ocns, and sub1 is kind of like
; rest. Your idea is to make add1 actually be cons, and sub1 acturally be rest...
